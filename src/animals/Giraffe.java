...
/**
 * Giraffe - herb food, starting weight 450 kg starting position x: 50, y: 0.
 * @author USER
 */
public class Giraffe
{
	...
	public Giraffe(String name)
	{
		...
		MessageUtility.logSetter(name, "setPosition", this.position, this.setPosition(50, 0));
		MessageUtility.logSetter(name, "setWeight", ((float)450), this.setWeight(450));
	}
	public Giraffe(String name, Point position)
	{
		distance = 0;
		MessageUtility.logConstractor(name);
		MessageUtility.logSetter(name, "setName", name, this.setName(name));
