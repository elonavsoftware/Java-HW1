...
/**
 * Elephant - herb food, starting weight 500 kg starting position x: 50, y: 90.
 * @author USER
 */
public class Elephant
{
	...
	public Elephant(String name)
	{
		...
		MessageUtility.logSetter(name, "setPosition", this.position, this.setPosition(50, 90));
		MessageUtility.logSetter(name, "setWeight", ((float)500), this.setWeight(500));
	}
